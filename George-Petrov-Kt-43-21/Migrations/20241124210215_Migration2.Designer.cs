...
namespace George_Petrov_Kt_43_21.Migrations
{
    ...
    [Migration("20241124210215_Migration2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("George_Petrov_Kt_43_21.Models.Degree", b =>
                {
            ...
            modelBuilder.Entity("George_Petrov_Kt_43_21.Models.Department", b =>
                {
            ...
            modelBuilder.Entity("George_Petrov_Kt_43_21.Models.Position", b =>
                {
            ...
            modelBuilder.Entity("George_Petrov_Kt_43_21.Models.Subject", b =>
                {
            ...
            modelBuilder.Entity("George_Petrov_Kt_43_21.Models.Teacher", b =>
                {
                    b.Property<int>("TeacherId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("George_Petrov_Kt_43_21.Models.TeachingLoad", b =>
                {
                    b.Property<int>("TeachingLoadId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("George_Petrov_Kt_43_21.Models.Department", b =>
                {
                    b.HasOne("George_Petrov_Kt_43_21.Models.Teacher", "Head")
                        .WithMany()
            ...
            modelBuilder.Entity("George_Petrov_Kt_43_21.Models.Subject", b =>
                {
                    b.HasOne("George_Petrov_Kt_43_21.Models.Teacher", "Teacher")
                        .WithMany()
                    ...
                    b.HasOne("George_Petrov_Kt_43_21.Models.TeachingLoad", "TeachingLoad")
                        .WithOne()
                        .HasForeignKey("George_Petrov_Kt_43_21.Models.Subject", "TeachingLoadId")
            ...
            modelBuilder.Entity("George_Petrov_Kt_43_21.Models.Teacher", b =>
                {
                    b.HasOne("George_Petrov_Kt_43_21.Models.Degree", "Degree")
                        .WithMany()
                    ...
                    b.HasOne("George_Petrov_Kt_43_21.Models.Department", "Department")
                        .WithMany("Teachers")
                    ...
                    b.HasOne("George_Petrov_Kt_43_21.Models.Position", "Position")
                        .WithMany()
